...
That installs the `akapulu` skill and the [docs MCP](https://docs.akapulu.com/mcp). The agent sends you to https://akapulu.com/api-keys to create a key, sets `AKAPULU_API_KEY` the way this project loads env vars, creates a Clara hosted link you can try, then shares docs for a custom UI and the rest of the product.
