# Akapulu agent plugins

Public skills for coding agents building on [Akapulu](https://akapulu.com) (live avatar conversations and scripted clips).
...
```text
Set up Akapulu for me: fetch https://docs.akapulu.com/agent-setup.md and follow it.
```
